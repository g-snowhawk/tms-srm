...
CREATE TABLE IF NOT EXISTS `TMS_receipt` (
  ...
  PRIMARY KEY (`issue_date`,`receipt_number`,`userkey`,`templatekey`),
...
CREATE TABLE IF NOT EXISTS `TMS_receipt_detail` (
  ...
  PRIMARY KEY (`issue_date`,`receipt_number`,`userkey`,`templatekey`,`page_number`,`line_number`),
  KEY `TMS_receipt_detail_ibfk_1` (`userkey`),
  KEY `TMS_receipt_detail_ibfk_2` (`templatekey`),
  KEY `TMS_receipt_detail_ibfk_3` (`receipt_number`),
  ...
  CONSTRAINT `TMS_receipt_detail_ibfk_3` FOREIGN KEY (`receipt_number`) REFERENCES `TMS_receipt` (`receipt_number`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
